(function() {
	...
	var marginTop = 20;
	var marginLeft = 100;
	var windowWidth = 1260;
	var windowHeight = 550;
	var radius = 8;
    var endTime = new Date(2016,3,3,11,0,0);
	var curShowSeconds = 0;
	var balls = [];
	var colors=["#33B5E5","#0099CC","#AA66CC","#9933CC","#99CC00","#669900","#FFBB33","#FF8800","#FF4444","#CC0000","#CCFF00","#AACC66"];
    //获得绘制环境并定义宽度和高度
	...
	function update() {
		...
		var nextShowSeconds = Math.round( (endTime.getTime() - nextTime.getTime()) / 1000);

		var curShowHour = parseInt(curShowSeconds / 3600);
		var curShowMinute = parseInt( (curShowSeconds - curShowHour * 3600) / 60 );
		var curShowSecond = curShowSeconds % 60;

		var nextShowHour = parseInt(nextShowSeconds / 3600);
		var nextShowMinute = parseInt( (nextShowSeconds - nextShowHour * 3600) / 60 );
		var nextShowSecond = nextShowSeconds % 60;
